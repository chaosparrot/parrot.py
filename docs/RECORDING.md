...
In order to make sure you only record the sound you want to record, you can alter the intensity setting at the start. I usuually choose a value between 1000 and 2000.
...
I found that you need around a 1000 samples to get decent recognition of a sound. You will get diminishing returns past 5000 samples. But you can try any amount and see if they recognize well.
